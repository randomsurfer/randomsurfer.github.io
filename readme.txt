...
== Changelog ==
= 1.1.2 = Nov 26, 2020
    * Fixed - custom js undefined elements fixed.
    * Added - recommend plugin added
    * code refined

= 1.1.1 = August 14, 2020
    * Fixed - customizer panel issue.
    * Fixed - demo import bug at theme settings page.
    
= 1.1.0 = May 28, 2020
    * Replaced  - about page with theme settings page.
    * Changed - screenshot image.
    * Updated - .pot file.

= 1.0.8 = April 6th, 2020
    * Sticky Header Script and style changes.
    * Social Icons target option added in customizer.
    * Code Refine.
    * Fixed - Sticky header disable issue.
